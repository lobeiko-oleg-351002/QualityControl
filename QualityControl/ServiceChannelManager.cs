        ...
        public static ServiceChannelManager Instance
        {
            get
            {
                if (instance == null)
                {
                    ...
                    CertificateChannel = new CertificateRepository();
                    ControlMethodDocumentationChannel = new ControlMethodDocumentationRepository();
                    CustomerChannel = new CustomerRepository();
                    EquipmentChannel = new EquipmentRepository();
                    MaterialChannel = new MaterialRepository();
                    RequirementDocumentationChannel = new RequirementDocumentationRepository();
                    WeldJointChannel = new WeldJointRepository();
                    TemplateChannel = new TemplateRepository();
                    ControlNameChannel = new ControlNameRepository();
                    ComponentChannel = new ComponentRepository();
                    EmployeeChannel = new EmployeeRepository();
                    IndustrialObjectChannel = new IndustrialObjectRepository();
                    JournalChannel = new JournalRepository();
                    ImageChannel = new ImageRepository();
                    UserChannel = new UserRepository();
                    RoleChannel = new RoleRepository();
                }
                return instance;
            }
        }
